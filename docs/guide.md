...
The current stable release is [2026.1.7].
...
Use the `--checkout` option with the [current stable release][2026.1.7]:

```console
cruft create https://github.com/statisticsnorway/ssb-pypitemplate.git --checkout=2026.1.7
```
...
[2026.1.7]: https://github.com/cjolowicz/cookiecutter-hypermodern-python/releases/tag/2026.1.7
